...
class Client:
    ...
    # CRDS_ADDRESS = s.getsockname()[0]
    # s.close()
    # CRDS_ADDRESS = socket.gethostbyname(socket.gethostname())
    #CRDS_ADDRESS = socket.getaddrinfo('localhost', None, socket.AF_INET)[0][4][0]
    #CRDS_ADDRESS = "localhost"
    CRDS_ADDRESS = "239.255.255.250"
