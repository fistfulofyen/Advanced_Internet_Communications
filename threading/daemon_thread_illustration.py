...
# When true, it means that the thread will be terminated
# when the calling script exits. Otherwise the script will not
# exit until any threads have completed execution.
# When true, the calling script doesn't have to worry about
# terminating threads that it has created.
